...
* `default_service` -
  (Required)
  The backend service or to use when none of the given rules match.
...
* `default_service` -
  (Required)
  The backend service or to use when none of the given paths match.
...
* `service` -
  (Required)
  The backend service or to use if any of the given paths match.
...
* `service` -
  (Required)
  The backend service or link that should be matched by this test.
