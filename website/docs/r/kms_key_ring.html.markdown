...
$ terraform import google_kms_key_ring.default projects/{{project}}/locations/{{location}}/keyRings?keyRingId={{name}}/{{name}}
$ terraform import google_kms_key_ring.default {{project}}/{{location}}/{{name}}/{{name}}
$ terraform import google_kms_key_ring.default {{location}}/{{name}}/{{name}}
```
