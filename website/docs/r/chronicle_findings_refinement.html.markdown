...
* `id` - an identifier for the resource with format `projects/{{project}}/locations/{{location}}/instances/{{instance}}/findingsRefinements/{{findings_refinement_id}}`
...
* `findings_refinement_id` -
  Findings Refinement Id is the ID of the Findings Refinement.
...
* `{{project}}/{{location}}/{{instance}}/{{findings_refinement_id}}`
* `{{location}}/{{instance}}/{{findings_refinement_id}}`
...
import {
  identity = {
    findingsRefinementId = "<-optional value->"
...
```tf
import {
  id = "projects/{{project}}/locations/{{location}}/instances/{{instance}}/findingsRefinements/{{findings_refinement_id}}"
  to = google_chronicle_findings_refinement.default
}
```
...
```
$ terraform import google_chronicle_findings_refinement.default projects/{{project}}/locations/{{location}}/instances/{{instance}}/findingsRefinements/{{findings_refinement_id}}
$ terraform import google_chronicle_findings_refinement.default {{project}}/{{location}}/{{instance}}/{{findings_refinement_id}}
$ terraform import google_chronicle_findings_refinement.default {{location}}/{{instance}}/{{findings_refinement_id}}
```
