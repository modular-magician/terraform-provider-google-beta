...
* `repository_config` -
  ...
  Structure is [documented below](#nested_repository_config).


<a name="nested_repository_config"></a>The `repository_config` block supports:

* `pypi_repository_config` -
  (Optional)
  Configuration for PyPi repository.
  Structure is [documented below](#nested_pypi_repository_config).


<a name="nested_pypi_repository_config"></a>The `pypi_repository_config` block supports:
