...
```
$ terraform import google_bigquery_dataset.default projects/{{project}}/datasets/{{name}}
$ terraform import google_bigquery_dataset.default {{project}}/{{name}}
$ terraform import google_bigquery_dataset.default {{name}}
```
