...
* `unredacted_bigquery_export_settings` -
  ...
  Structure is [documented below](#nested_snapshot_app_logging_settings_unredacted_bigquery_export_settings).
...
<a name="nested_snapshot_app_logging_settings_unredacted_bigquery_export_settings"></a>The `unredacted_bigquery_export_settings` block contains:
