...
* `key_interconnect` - (Required) The identifier for this object. Format specified above.
...
<a name="nested_physical_structure_metros"></a>The `metros` block supports:
...
<a name="nested_physical_structure_metros_metros_facilities"></a>The `facilities` block supports:
...
<a name="nested_physical_structure_metros_metros_facilities_facilities_zones"></a>The `zones` block supports:
...
<a name="nested_configured_topology_capability"></a>The `topology_capability` block supports:

* `supported_sla` -
  (Optional)
  Which level of reliability this group is configured to
  support.
  Possible values are: `PRODUCTION_CRITICAL`, `PRODUCTION_NON_CRITICAL`, `NO_SLA`, `UNSPECIFIED`.
...
<a name="nested_configured_topology_capability_intended_capability_blockers"></a>The `intended_capability_blockers` block supports:
...
* `blocker_type` -
  ...
  Possible values are: `UNSPECIFIED`, `NO_INTERCONNECTS`, `INCOMPATIBLE_METROS`, `NO_INTERCONNECTS_IN_METRO_AND_ZONE`, `NOT_AVAILABLE`, `OTHER`.
