...
resource "google_compute_network_peering_routes_config" "peering_primary_routes" {
  name    = google_compute_network_peering.peering_primary.name
...
resource "google_compute_network_peering_routes_config" "peering_gke_routes" {
  name    = google_container_cluster.private_cluster.private_cluster_config[0].peering_name
...
```
$ terraform import google_compute_network_peering_routes_config.default projects/{{project}}/global/networks/{{network}}/networkPeerings/{{name}}
$ terraform import google_compute_network_peering_routes_config.default {{project}}/{{network}}/{{name}}
$ terraform import google_compute_network_peering_routes_config.default {{network}}/{{name}}
```
