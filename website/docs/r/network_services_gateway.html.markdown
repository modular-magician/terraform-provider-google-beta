...
* `delete_swg_autogen_router_on_destroy` - (Optional) UPDATEDWhen deleting a gateway of type 'SECURE_WEB_GATEWAY', this boolean option will also delete auto generated router by the gateway creation.
