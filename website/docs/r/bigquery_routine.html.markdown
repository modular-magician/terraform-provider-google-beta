...
* `table_type` -
  ...
  Structure is [documented below](#nested_arguments_arguments_table_type).


<a name="nested_arguments_arguments_table_type"></a>The `table_type` block supports:

* `columns` -
  (Optional)
  The columns in the table type.
  Structure is [documented below](#nested_arguments_arguments_table_type_columns).


<a name="nested_arguments_arguments_table_type_columns"></a>The `columns` block supports:
