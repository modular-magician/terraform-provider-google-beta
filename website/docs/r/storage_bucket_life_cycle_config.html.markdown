...
* `lifecycle_rule` -
  (Optional)
  Structure is [documented below](#nested_lifecycle_rule).
...
* `action` -
  (Required)
  The action to take.
  Structure is [documented below](#nested_lifecycle_rule_lifecycle_rule_action).

* `condition` -
  (Required)
  The condition(s) under which the action will be taken.
  Structure is [documented below](#nested_lifecycle_rule_lifecycle_rule_condition).


<a name="nested_lifecycle_rule_lifecycle_rule_action"></a>The `action` block supports:
...
<a name="nested_lifecycle_rule_lifecycle_rule_condition"></a>The `condition` block supports:
