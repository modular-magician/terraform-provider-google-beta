...
# google_service_directory_endpointabc1
...
To get more information about Endpointabc1, see:
...
Endpointabc1 can be imported using any of these accepted formats:
...
In Terraform v1.5.0 and later, use an [`import` block](https://developer.hashicorp.com/terraform/language/import) to import Endpointabc1 using one of the formats above. For example:

```tf
import {
  id = "projects/{{project}}/locations/{{location}}/namespaces/{{namespace_id}}/services/{{service_id}}/endpoints/{{endpoint_id}}"
  to = google_service_directory_endpointabc1.default
}
```

When using the [`terraform import` command](https://developer.hashicorp.com/terraform/cli/commands/import), Endpointabc1 can be imported using one of the formats above. For example:

```
$ terraform import google_service_directory_endpointabc1.default projects/{{project}}/locations/{{location}}/namespaces/{{namespace_id}}/services/{{service_id}}/endpoints/{{endpoint_id}}
$ terraform import google_service_directory_endpointabc1.default {{project}}/{{location}}/{{namespace_id}}/{{service_id}}/{{endpoint_id}}
$ terraform import google_service_directory_endpointabc1.default {{location}}/{{namespace_id}}/{{service_id}}/{{endpoint_id}}
```
