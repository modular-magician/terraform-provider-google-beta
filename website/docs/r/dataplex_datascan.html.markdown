...
<a name="nested_scanned_data"></a>The `scanned_data` block supports:
...
<a name="nested_string_profile"></a>The `string_profile` block supports:
...
<a name="nested_integer_profile"></a>The `integer_profile` block supports:
...
<a name="nested_double_profile"></a>The `double_profile` block supports:
