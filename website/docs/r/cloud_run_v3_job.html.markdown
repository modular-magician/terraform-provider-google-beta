...
import {
  ...
  to = google_cloud_run_v3_job.default
}
```
...
```
$ terraform import google_cloud_run_v3_job.default projects/{{project}}/locations/{{location}}/jobs/{{name}}
$ terraform import google_cloud_run_v3_job.default {{project}}/{{location}}/{{name}}
$ terraform import google_cloud_run_v3_job.default {{location}}/{{name}}
```
