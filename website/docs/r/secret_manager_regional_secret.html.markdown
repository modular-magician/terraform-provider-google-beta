...
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
  <a href="https://console.cloud.google.com/cloudshell/open?cloudshell_git_repo=https%3A%2F%2Fgithub.com%2Fterraform-google-modules%2Fdocs-examples.git&cloudshell_image=gcr.io%2Fcloudshell-images%2Fcloudshell%3Alatest&cloudshell_print=.%2Fmotd&cloudshell_tutorial=.%2Ftutorial.md&cloudshell_working_dir=secret_regional_basic&open_in_editor=main.tf" target="_blank">
    <img alt="Open in Cloud Shell" src="//gstatic.com/cloudssh/images/open-btn.svg" style="max-height: 44px; margin: 32px auto; max-width: 100%;">
  </a>
</div>
## Example Usage - Secret Regional Basic
...
* `region` -
  (Optional)
  The region of the Secret, eg us-central1.
...
* `id` - an identifier for the resource with format `projects/{{project}}/locations/{{region}}/secrets/{{secret_id}}`
...
```tf
import {
  id = "projects/{{project}}/locations/{{region}}/secrets/{{secret_id}}"
...
```
$ terraform import google_secret_manager_regional_secret.default projects/{{project}}/locations/{{region}}/secrets/{{secret_id}}
$ terraform import google_secret_manager_regional_secret.default {{project}}/{{region}}/{{secret_id}}
$ terraform import google_secret_manager_regional_secret.default {{region}}/{{secret_id}}
$ terraform import google_secret_manager_regional_secret.default {{secret_id}}
```
