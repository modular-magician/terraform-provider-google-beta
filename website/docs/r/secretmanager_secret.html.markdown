...
```
$ terraform import -provider=google-beta google_secretmanager_secret.default projects/{{project}}/secrets/{{name}}
$ terraform import -provider=google-beta google_secretmanager_secret.default {{project}}/{{name}}
$ terraform import -provider=google-beta google_secretmanager_secret.default {{name}}
```
