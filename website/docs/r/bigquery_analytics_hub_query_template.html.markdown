...
<div class = "oics-button" style="float: right; margin: 0 0 -15px">
  <a href="https://console.cloud.google.com/cloudshell/open?cloudshell_git_repo=https%3A%2F%2Fgithub.com%2Fterraform-google-modules%2Fdocs-examples.git&cloudshell_image=gcr.io%2Fcloudshell-images%2Fcloudshell%3Alatest&cloudshell_print=.%2Fmotd&cloudshell_tutorial=.%2Ftutorial.md&cloudshell_working_dir=bigquery_analyticshub_query_template_basic&open_in_editor=main.tf" target="_blank">
    <img alt="Open in Cloud Shell" src="//gstatic.com/cloudssh/images/open-btn.svg" style="max-height: 44px; margin: 32px auto; max-width: 100%;">
  </a>
</div>
## Example Usage - Bigquery Analyticshub Query Template Basic
...
resource "google_bigquery_analytics_hub_query_template" "querytemplate" {
  ...
  routine {
    ...
    definition_body="qt1(t1 ANY TABLE) as (select * from t1)"
  }
  submit=false
...
* `routine_type` -
  ...
  Default value is `ROUTINE_TYPE_UNSPECIFIED`.
  Possible values are: `ROUTINE_TYPE_UNSPECIFIED`, `TABLE_VALUED_FUNCTION`.
