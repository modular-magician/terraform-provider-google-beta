...
* `instance_type` -
  ...
  Possible values are `INSTANCE_TYPE_UNSPECIFIED`, `PRIMARY`, and `READ_POOL`.
...
* `id` - an identifier for the resource with format `projects/{{project}}/locations/{{location}}/clusters/{{cluster_id}}/instances/{{instance_id}}`
...
```
$ terraform import google_alloydb_instance.default projects/{{project}}/locations/{{location}}/clusters/{{cluster_id}}/instances/{{instance_id}}
$ terraform import google_alloydb_instance.default {{project}}/{{location}}/{{cluster_id}}/{{instance_id}}
$ terraform import google_alloydb_instance.default {{location}}/{{cluster_id}}/{{instance_id}}
$ terraform import google_alloydb_instance.default {{instance_id}}
```
