...
description: |-
  List App Lifecycle Manager (SaaS Runtime) unitoperation resources in a project for use with terraform query
  and .tfquery.hcl files.
---

# google_saas_runtime_unit_operation (list)

Lists [`google_saas_runtime_unit_operation`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_saas_runtime_unit_operation) resources for use with [`terraform query`](https://developer.hashicorp.com/terraform/cli/commands/query) and **`.tfquery.hcl`** files.
...
```hcl
list "google_saas_runtime_unit_operation" "all" {
  provider = google
...
By default each result includes **resource identity** for [`google_saas_runtime_unit_operation`](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_saas_runtime_unit_operation) (see [Resource identity](https://developer.hashicorp.com/terraform/language/block/import#identity)).

With `include_resource = true` on the `list` block, results also include the full resource-style attributes documented for the managed [`google_saas_runtime_unit_operation` resource](https://registry.terraform.io/providers/hashicorp/google/latest/docs/resources/google_saas_runtime_unit_operation#attributes-reference).
