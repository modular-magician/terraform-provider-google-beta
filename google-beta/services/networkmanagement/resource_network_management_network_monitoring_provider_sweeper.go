...
func listAndActionNetworkManagementNetworkMonitoringProvider(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkmanagement.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/networkMonitoringProviders", "?")[0]
...
func deleteResourceNetworkManagementNetworkMonitoringProvider(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkmanagement.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/networkMonitoringProviders/{{network_monitoring_provider_id}}"
