...
func TestAccBackupDRBackupVault_backupDrBackupVaultBasicExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccBackupDRBackupVault_backupDrBackupVaultBasicExample(context),
			},
			{
...
func testAccBackupDRBackupVault_backupDrBackupVaultBasicExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_backup_dr_backup_vault" "backup-vault-test" {
  provider = google-beta
  location = "us-central1"
  backup_vault_id    = "tf-test-tf-test-backup-vault-test%{random_suffix}%{random_suffix}"
