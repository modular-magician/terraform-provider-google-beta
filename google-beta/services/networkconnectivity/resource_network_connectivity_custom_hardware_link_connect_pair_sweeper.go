...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionNetworkConnectivityCustomHardwareLinkConnectPair,
		DeleteFunction: testSweepNetworkConnectivityCustomHardwareLinkConnectPair,
	}
...
func testSweepNetworkConnectivityCustomHardwareLinkConnectPair(_ string) error {
	return listAndActionNetworkConnectivityCustomHardwareLinkConnectPair(deleteResourceNetworkConnectivityCustomHardwareLinkConnectPair)
}

func listAndActionNetworkConnectivityCustomHardwareLinkConnectPair(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "NetworkConnectivityCustomHardwareLinkConnectPair"
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://networkconnectivity.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/customHardwareLinkConnectPairs", "?")[0]
		...
		resourceList, ok := res["customHardwareLinkConnectPairs"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'customHardwareLinkConnectPairs'")
		} else {
...
func deleteResourceNetworkConnectivityCustomHardwareLinkConnectPair(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://networkconnectivity.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/customHardwareLinkConnectPairs/{{custom_hardware_link_connect_pair_id}}"
