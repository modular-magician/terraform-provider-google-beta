...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_licensemanager_license_configuration",
		ListAndAction:  listAndActionLicenseManagerLicenseConfiguration,
		DeleteFunction: testSweepLicenseManagerLicenseConfiguration,
	}
...
func testSweepLicenseManagerLicenseConfiguration(_ string) error {
	return listAndActionLicenseManagerLicenseConfiguration(deleteResourceLicenseManagerLicenseConfiguration)
}

func listAndActionLicenseManagerLicenseConfiguration(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "LicenseManagerLicenseConfiguration"
	...
	for _, mockConfig := range configs {
		...
		resourceList, ok := res["licenseConfigurations"]
		if ok {
			log.Printf("[INFO][SWEEPER_LOG] Found resources under expected key 'licenseConfigurations'")
		} else {
...
func deleteResourceLicenseManagerLicenseConfiguration(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://licensemanager.googleapis.com/v1/projects/{{project}}/locations/{{location}}/configurations/{{license_configuration_name}}"
