...
func init() {
	...
	s := &sweeper.Sweeper{
		Name:           "google_saas_unit_kind",
		ListAndAction:  listAndActionSaasUnitKind,
		DeleteFunction: testSweepSaasUnitKind,
	}
...
func testSweepSaasUnitKind(_ string) error {
	return listAndActionSaasUnitKind(deleteResourceSaasUnitKind)
}

func listAndActionSaasUnitKind(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "SaasUnitKind"
...
func deleteResourceSaasUnitKind(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
