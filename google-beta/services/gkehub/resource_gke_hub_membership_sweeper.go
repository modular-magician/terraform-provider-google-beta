...
func listAndActionGKEHubMembership(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://gkehub.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/memberships", "?")[0]
...
func deleteResourceGKEHubMembership(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://gkehub.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/memberships/{{membership_id}}"
