...
func TestAccSaasRuntimeUnitOperation_saasRuntimeUnitOperationWithRolloutExample(t *testing.T) {
	t.Parallel()
	acctest.BootstrapIamMembers(t, []acctest.IamMember{
		{
			Member: "serviceAccount:service-{project_number}@gcp-sa-saasservicemgmt.iam.gserviceaccount.com",
	...
	context := map[string]interface{}{
		...
		"provision_operation_name":   "tf-test-provision-unit-operation" + randomSuffix,
		"release_name":               "tf-test-example-release" + randomSuffix,
		"rollout_name":               "tf-test-example-rollout" + randomSuffix,
		"saas_name":                  "tf-test-example-saas" + randomSuffix,
		"tenant_name":                "tf-test-example-tenant" + randomSuffix,
		"tenant_project_name":        "tenant" + randomSuffix,
		"unit_name":                  "tf-test-example-unit" + randomSuffix,
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccSaasRuntimeUnitOperation_saasRuntimeUnitOperationWithRolloutExample(context),
			},
			{
				ResourceName:            "google_saas_runtime_unit_operation.provision_unit_operation",
				ImportState:             true,
...
func testAccSaasRuntimeUnitOperation_saasRuntimeUnitOperationWithRolloutExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
locals {
  location          = "us-east1"
  tenant_project_id = "%{tenant_project_name}"
