...
func TestAccBigqueryAnalyticsHubListing_multiregion(t *testing.T) {
	// Skip if not running in a acc test environment as BQ DDL bootstrapping is required
	...
	// BOOTSTRAP: Create dataset and replica via Go client (Terraform cannot create replicas on existing datasets)
	...
	// CLEANUP: Ensure the bootstrapped resources are deleted
	t.Cleanup(func() {
