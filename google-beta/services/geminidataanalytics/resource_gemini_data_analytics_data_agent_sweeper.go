...
func listAndActionGeminiDataAnalyticsDataAgent(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://geminidataanalytics.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/dataAgents", "?")[0]
...
func deleteResourceGeminiDataAnalyticsDataAgent(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://geminidataanalytics.googleapis.com/v1beta/projects/{{project}}/locations/{{location}}/dataAgents/{{data_agent_id}}:deleteSync"
