...
func TestAccTpuV2Vm_tpuV2VmAutocheckpointExample(t *testing.T) {
	acctest.SkipIfVcr(t)
	t.Parallel()
	...
	context := map[string]interface{}{
		"vm_name":       "tf-test-test-tpu-autochkpt" + randomSuffix,
		"random_suffix": randomSuffix,
	}
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccTpuV2Vm_tpuV2VmAutocheckpointExample(context),
			},
			{
				ResourceName:            "google_tpu_v2_vm.tpu",
				ImportState:             true,
...
func testAccTpuV2Vm_tpuV2VmAutocheckpointExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
data "google_tpu_v2_runtime_versions" "available" {
  provider = google-beta
}
