	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateVerifyIgnore: []string{"labels", "gateway_config", "grpc_services", "terraform_labels", "api", "api_config_id"},
			},
		},
	})
}
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportState:             true,
				ImportStateVerify:       true,
				ImportStateVerifyIgnore: []string{"labels", "gateway_config", "grpc_services", "terraform_labels", "api", "api_config_id", "grpc_services.0.file_descriptor_set"},
			},
		},
	})
}
