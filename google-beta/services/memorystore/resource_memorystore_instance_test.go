	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				Config: createOrUpdateMemorystoreInstance(&InstanceParams{name: name, replicaCount: 0, shardCount: 3, preventDestroy: true, zoneDistributionMode: "MULTI_ZONE", deletionProtectionEnabled: false}),
			},
			{
				ResourceName:      "google_memorystore_instance.test",
				ImportState:       true,
			...
			},
			{
				...
				Config: createOrUpdateMemorystoreInstance(&InstanceParams{name: name, replicaCount: 0, shardCount: 3, preventDestroy: false, zoneDistributionMode: "MULTI_ZONE", deletionProtectionEnabled: false}),
			},
		},
	})
}
		...
		Steps: []resource.TestStep{
			{
				...
				Config: createOrUpdateMemorystoreInstance(&InstanceParams{name: name, replicaCount: 0, shardCount: 3, preventDestroy: true, nodeType: "REDIS_STANDARD_SMALL", zoneDistributionMode: "MULTI_ZONE", persistenceMode: "AOF", deletionProtectionEnabled: false}),
			},
			{
				ResourceName:      "google_memorystore_instance.test",
				ImportState:       true,
			...
			},
			{
				...
				Config: createOrUpdateMemorystoreInstance(&InstanceParams{name: name, replicaCount: 0, shardCount: 3, preventDestroy: true, nodeType: "REDIS_STANDARD_SMALL", zoneDistributionMode: "MULTI_ZONE", persistenceMode: "RDB", deletionProtectionEnabled: false}),
			},
			{
				ResourceName:      "google_memorystore_instance.test",
				ImportState:       true,
			...
			{
				// clean up the resource
				Config: createOrUpdateMemorystoreInstance(&InstanceParams{name: name, replicaCount: 0, shardCount: 3, preventDestroy: false, nodeType: "REDIS_STANDARD_SMALL", zoneDistributionMode: "MULTI_ZONE", persistenceMode: "RDB", deletionProtectionEnabled: false}),
			},
		},
	})
}
...
func createOrUpdateMemorystoreInstance(params *InstanceParams) string {
	...
	persistenceBlock := ""
	if params.persistenceMode == "RDB" {
		persistenceBlock = "persistenceConfig = {mode: = \"RDB\"}"
	}
	if params.persistenceMode == "AOF" {
		persistenceBlock = "persistenceConfig = {mode: \"AOF\"}"
	}
