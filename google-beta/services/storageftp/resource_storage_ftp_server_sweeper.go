...
func listAndActionStorageFtpServer(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://ftp.googleapis.com/v1alpha/projects/{{project}}/locations/{{location}}/servers", "?")[0]
...
func deleteResourceStorageFtpServer(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://ftp.googleapis.com/v1alpha/projects/{{project}}/locations/{{location}}/servers/{{server_id}}"
