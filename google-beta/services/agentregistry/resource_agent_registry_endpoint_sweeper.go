...
func init() {
	...
	s := &sweeper.Sweeper{
		...
		ListAndAction:  listAndActionAgentRegistryEndpoint,
		DeleteFunction: testSweepAgentRegistryEndpoint,
	}
...
func testSweepAgentRegistryEndpoint(_ string) error {
	return listAndActionAgentRegistryEndpoint(deleteResourceAgentRegistryEndpoint)
}

func listAndActionAgentRegistryEndpoint(action sweeper.ResourceAction) error {
	var lastError error
	resourceName := "AgentRegistryEndpoint"
...
func deleteResourceAgentRegistryEndpoint(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://agentregistry.googleapis.com/v1alpha/projects/{{project}}/locations/{{location}}/services/{{endpoint_id}}"
