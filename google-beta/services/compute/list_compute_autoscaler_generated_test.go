		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					listDisplayName.Capture(
						"google_compute_autoscaler.default",
						[]string{
							"name",
						},
					),
			...
			{
				Query:           true,
				Config:          testAccComputeAutoscaler_autoscalerSingleInstanceExampleListQuery(context),
...
func testAccComputeAutoscaler_autoscalerSingleInstanceExampleListQuery(context map[string]interface{}) string {
