...
func TestAccComputeNetworkEdgeSecurityServiceListQuery_generated(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Query:           true,
				Config:          testAccComputeNetworkEdgeSecurityService_computeNetworkEdgeSecurityServiceBasicExampleListQuery(context),
				ConfigVariables: listScope.AsConfigVariables(),
				QueryResultChecks: []querycheck.QueryResultCheck{
					querycheck.ExpectLengthAtLeast("google_compute_network_edge_security_service.list_query", 1),
					querycheck.ExpectResourceDisplayName(
						"google_compute_network_edge_security_service.list_query",
...
func testAccComputeNetworkEdgeSecurityService_computeNetworkEdgeSecurityServiceBasicExampleListQuery(context map[string]interface{}) string {
	return acctest.Nprintf(`
list "google_compute_network_edge_security_service" "list_query" {
