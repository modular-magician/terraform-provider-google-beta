...
func TestAccComputeRegionInstanceTemplate_location_hint(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeRegionInstanceTemplate_location_hint(acctest.RandString(t, 10)),
				Check: resource.ComposeTestCheckFunc(
					testAccCheckComputeRegionInstanceTemplateExists(
						t, "google_compute_region_instance_template.foobar", &instanceTemplate),
...
func testAccComputeRegionInstanceTemplate_location_hint(suffix string) string {
	return fmt.Sprintf(`
data "google_compute_image" "my_image" {
  family  = "debian-11"
  project = "debian-cloud"
