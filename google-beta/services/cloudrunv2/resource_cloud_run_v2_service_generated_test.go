...
func TestAccCloudRunV2Service_cloudrunv2ServiceAgentIdentityExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudRunV2Service_cloudrunv2ServiceAgentIdentityExample(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_service.default",
				ImportState:             true,
			...
			{
				Config: testAccCloudRunV2Service_cloudrunv2ServiceAgentIdentityUpdateExample(context_1),
				ConfigPlanChecks: resource.ConfigPlanChecks{
					PreApply: []plancheck.PlanCheck{
						plancheck.ExpectResourceAction("google_cloud_run_v2_service.default", plancheck.ResourceActionUpdate),
					},
...
func testAccCloudRunV2Service_cloudrunv2ServiceAgentIdentityExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_cloud_run_v2_service" "default" {
  provider = google-beta
  name     = "%{cloud_run_service_name}"
...
func testAccCloudRunV2Service_cloudrunv2ServiceAgentIdentityUpdateExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_cloud_run_v2_service" "default" {
  provider = google-beta
  name     = "%{cloud_run_service_name}"
...
func TestAccCloudRunV2Service_cloudrunv2ServiceMcpServerExample(t *testing.T) {
	t.Parallel()
	...
	acctest.VcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudRunV2Service_cloudrunv2ServiceMcpServerExample(context),
			},
			{
				ResourceName:            "google_cloud_run_v2_service.default",
				ImportState:             true,
...
func testAccCloudRunV2Service_cloudrunv2ServiceMcpServerExample(context map[string]interface{}) string {
	return acctest.Nprintf(`
resource "google_cloud_run_v2_service" "default" {
  provider = google-beta
  name     = "%{cloud_run_service_name}"
