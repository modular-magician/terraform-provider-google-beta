...
func listAndActionNetappHostGroup(action sweeper.ResourceAction) error {
	...
	for _, mockConfig := range configs {
		...
		// Prepare list URL
		listTemplate := strings.Split("https://netapp.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/hostGroups", "?")[0]
...
func deleteResourceNetappHostGroup(config *transport_tpg.Config, d *tpgresource.ResourceDataMock, obj map[string]interface{}) error {
	...
	deleteTemplate := "https://netapp.googleapis.com/v1beta1/projects/{{project}}/locations/{{location}}/hostGroups/{{name}}"
