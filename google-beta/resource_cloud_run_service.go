...
func resourceCloudRunServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("api_version", flattenCloudRunServiceApiVersion(res["apiVersion"], d)); err != nil {
		return fmt.Errorf("Error reading Service: %s", err)
	}
...
func flattenCloudRunServiceApiVersion(v interface{}, d *schema.ResourceData) interface{} {
	return v
}
