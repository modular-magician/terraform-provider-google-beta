...
func resourceAccessContextManagerGcpUserAccessBindingCreate(d *schema.ResourceData, meta interface{}) error {
	...
	group_keyProp, err := expandAccessContextManagerGcpUserAccessBindingGroupKey(d.Get("group_key"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("group_key"); !isEmptyValue(reflect.ValueOf(group_keyProp)) && (ok || !reflect.DeepEqual(v, group_keyProp)) {
		obj["group_key"] = group_keyProp
	}
	access_levelsProp, err := expandAccessContextManagerGcpUserAccessBindingAccessLevels(d.Get("access_levels"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("access_levels"); !isEmptyValue(reflect.ValueOf(access_levelsProp)) && (ok || !reflect.DeepEqual(v, access_levelsProp)) {
		obj["access_levels"] = access_levelsProp
	}
...
func resourceAccessContextManagerGcpUserAccessBindingRead(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := replaceVars(d, config, "{{AccessContextManagerBasePath}}organizations/{{organization_id}}/gcpUserAccessBindings/{{name}}")
	if err != nil {
		return err
	}
	...
	if err := d.Set("group_key", flattenAccessContextManagerGcpUserAccessBindingGroupKey(res["group_key"], d, config)); err != nil {
		return fmt.Errorf("Error reading GcpUserAccessBinding: %s", err)
	}
	if err := d.Set("access_levels", flattenAccessContextManagerGcpUserAccessBindingAccessLevels(res["access_levels"], d, config)); err != nil {
		return fmt.Errorf("Error reading GcpUserAccessBinding: %s", err)
	}
...
func resourceAccessContextManagerGcpUserAccessBindingUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("group_key"); !isEmptyValue(reflect.ValueOf(v)) && (ok || !reflect.DeepEqual(v, group_keyProp)) {
		obj["group_key"] = group_keyProp
	}
	access_levelsProp, err := expandAccessContextManagerGcpUserAccessBindingAccessLevels(d.Get("access_levels"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("access_levels"); !isEmptyValue(reflect.ValueOf(v)) && (ok || !reflect.DeepEqual(v, access_levelsProp)) {
		obj["access_levels"] = access_levelsProp
	}
	...
	if d.HasChange("group_key") {
		updateMask = append(updateMask, "group_key")
	}

	if d.HasChange("access_levels") {
		updateMask = append(updateMask, "access_levels")
	}
...
func resourceAccessContextManagerGcpUserAccessBindingImport(d *schema.ResourceData, meta interface{}) ([]*schema.ResourceData, error) {
	...
	if err := parseImportId([]string{
		"organizations/(?P<organization_id>[^/]+)/gcpUserAccessBindings/(?P<name>[^/]+)",
