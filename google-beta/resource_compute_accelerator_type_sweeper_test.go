...
func testSweepComputeAcceleratorType(region string) error {
	...
	listTemplate := strings.Split("https://compute.googleapis.com/compute/beta/projects/{{project}}/aggregated/acceleratorTypes", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://compute.googleapis.com/compute/beta/projects/{{project}}/zones/{{zone}}/acceleratorTypes/{{name}}"
		if obj["zone"] == nil {
