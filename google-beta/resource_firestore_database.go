...
for information about how to choose. Possible values: ["FIRESTORE_NATIVE", "DATASTORE_MODE"]`,
			...
			"app_engine_integration_mode": {
				...
				Description:  `The App Engine integration mode to use for this database. Default value: "DISABLED" Possible values: ["ENABLED", "DISABLED"]`,
				Default:      "DISABLED",
			},
			"concurrency_mode": {
				Type:         schema.TypeString,
			...
			"delete_protection_state": {
				Type:         schema.TypeString,
				Optional:     true,
				ValidateFunc: validateEnum([]string{"DELETE_PROTECTION_DISABLED", "DELETE_PROTECTION_ENABLED", ""}),
				Description:  `State of delete protection for the database. Default value: "DELETE_PROTECTION_DISABLED" Possible values: ["DELETE_PROTECTION_DISABLED", "DELETE_PROTECTION_ENABLED"]`,
...
func resourceFirestoreDatabaseCreate(d *schema.ResourceData, meta interface{}) error {
	...
	delete_protection_stateProp, err := expandFirestoreDatabaseDeleteProtectionState(d.Get("delete_protection_state"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("delete_protection_state"); !isEmptyValue(reflect.ValueOf(delete_protection_stateProp)) && (ok || !reflect.DeepEqual(v, delete_protection_stateProp)) {
		obj["delete_protection_state"] = delete_protection_stateProp
	}

	obj, err = resourceFirestoreDatabaseEncoder(d, meta, obj)
	if err != nil {
		return err
	}
	...
	opRes, err = resourceFirestoreDatabaseDecoder(d, meta, opRes)
	if err != nil {
...
func resourceFirestoreDatabaseRead(d *schema.ResourceData, meta interface{}) error {
	...
	res, err = resourceFirestoreDatabaseDecoder(d, meta, res)
	if err != nil {
		return err
	}
	...
	if res == nil {
		...
		log.Printf("[DEBUG] Removing FirestoreDatabase because it no longer exists.")
		d.SetId("")
		return nil
	}
...
func resourceFirestoreDatabaseUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("delete_protection_state"); !isEmptyValue(reflect.ValueOf(v)) && (ok || !reflect.DeepEqual(v, delete_protection_stateProp)) {
		obj["delete_protection_state"] = delete_protection_stateProp
	}
	...
	if d.HasChange("delete_protection_state") {
		updateMask = append(updateMask, "delete_protection_state")
	}
...
func expandFirestoreDatabaseDeleteProtectionState(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func resourceFirestoreDatabaseEncoder(d *schema.ResourceData, meta interface{}, obj map[string]interface{}) (map[string]interface{}, error) {
...
func resourceFirestoreDatabaseDecoder(d *schema.ResourceData, meta interface{}, res map[string]interface{}) (map[string]interface{}, error) {
	config := meta.(*Config)
