...
func resourceCloudSchedulerJobCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("app_engine_http_target"); !isEmptyValue(reflect.ValueOf(appEngineHttpTargetProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("http_target"); !isEmptyValue(reflect.ValueOf(httpTargetProp)) {
