...
func resourceKmsCryptoKeyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := replaceVars(d, config, "https://cloudkms.googleapis.com/v1/{{key_ring}}/cryptoKeys?cryptoKeyId={{name}}")
	if err != nil {
		return err
	}
...
func resourceKmsCryptoKeyRead(d *schema.ResourceData, meta interface{}) error {
	...
	url, err := replaceVars(d, config, "https://cloudkms.googleapis.com/v1/{{key_ring}}/cryptoKeys/{{name}}")
	if err != nil {
		return err
	}
