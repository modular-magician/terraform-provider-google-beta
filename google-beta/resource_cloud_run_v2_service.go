...
func expandCloudRunV2ServiceTemplateContainers(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	for _, raw := range l {
		...
		if err != nil {
			return nil, err
		} else if val := reflect.ValueOf(transformedDependsOn); val.IsValid() && !isEmptyValue(val) {
...
func expandCloudRunV2ServiceTemplateContainersDependsOn(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
...
func expandCloudRunV2ServiceTemplateVolumes(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	...
	for _, raw := range l {
		...
		if err != nil {
			return nil, err
		} else if val := reflect.ValueOf(transformedEmptyDir); val.IsValid() && !isEmptyValue(val) {
...
func expandCloudRunV2ServiceTemplateVolumesEmptyDir(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedMedium); val.IsValid() && !isEmptyValue(val) {
	...
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedSizeLimit); val.IsValid() && !isEmptyValue(val) {
...
func expandCloudRunV2ServiceTemplateVolumesEmptyDirMedium(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}

func expandCloudRunV2ServiceTemplateVolumesEmptyDirSizeLimit(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
