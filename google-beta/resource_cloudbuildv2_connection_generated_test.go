...
resource "google_cloudbuildv2_connection" "primary" {
  ...
  github_enterprise_config {
    ...
    service_directory_config {
      service = "projects/1033762898806/locations/%{region}/namespaces/ghe-sd/services/ghe-proctor-private-ca-com"
    }
...
resource "google_cloudbuildv2_connection" "primary" {
  ...
  github_config {
    app_installation_id = 633612

    authorizer_credential {
      oauth_token_secret_version = "projects/1033762898806/secrets/gcbrepos-dcltest-github-token/versions/1"
    }
  }
