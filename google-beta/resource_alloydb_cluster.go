...
A duration in seconds with up to nine fractional digits, terminated by 's'. Example: "3.5s".`,
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"days_of_week": {
										Type:        schema.TypeList,
										Optional:    true,
										Description: `The days of the week to perform a backup. At least one day of the week must be provided. Possible values: ["DAY_OF_WEEK_UNSPECIFIED", "MONDAY", "TUESDAY", "WEDNESDAY", "THURSDAY", "FRIDAY", "SATURDAY", "SUNDAY"]`,
										Elem: &schema.Schema{
											Type:         schema.TypeString,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"ca_source": {
							Type:         schema.TypeString,
							Optional:     true,
							ValidateFunc: validateEnum([]string{"CA_SOURCE_MANAGED", "CA_SOURCE_UNSPECIFIED", ""}),
							Description:  `The Certificate Authority (CA) source. Default value: "CA_SOURCE_MANAGED" Possible values: ["CA_SOURCE_MANAGED", "CA_SOURCE_UNSPECIFIED"]`,
							Default:      "CA_SOURCE_MANAGED",
						},
						"ssl_mode": {
							Type:         schema.TypeString,
							Optional:     true,
							ValidateFunc: validateEnum([]string{"SSL_MODE_UNSPECIFIED", "SSL_MODE_ALLOW", "SSL_MODE_REQUIRE", "SSL_MODE_VERIFY_CA", ""}),
							Description:  `The SSL mode. Specifies client-server SSL/TLS connection behavior. Default value: "SSL_MODE_ALLOW" Possible values: ["SSL_MODE_UNSPECIFIED", "SSL_MODE_ALLOW", "SSL_MODE_REQUIRE", "SSL_MODE_VERIFY_CA"]`,
							Default:      "SSL_MODE_ALLOW",
						},
					},
				},
			},
			...
			"create_time": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: `Time the Cluster was created in UTC.`,
			},
			"database_version": {
				Type:        schema.TypeString,
				Computed:    true,
			...
			"reconciling": {
				Type:        schema.TypeBool,
				Computed:    true,
				Description: `Set to true if the current state of Cluster does not match the user's intended state, and the service is actively updating the resource to reconcile them. This can happen due to user-triggered updates or system actions like failover or maintenance.`,
			},
			"self_link": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: `The selfLink of the alloydb cluster.`,
			},
			"state": {
				Type:        schema.TypeString,
				Computed:    true,
			...
			"update_time": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: `Time the Cluster was updated in UTC.`,
			},
			"project": {
				Type:     schema.TypeString,
				Optional: true,
...
func resourceAlloydbClusterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	sslConfigProp, err := expandAlloydbClusterSslConfig(d.Get("ssl_config"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("ssl_config"); !isEmptyValue(reflect.ValueOf(sslConfigProp)) && (ok || !reflect.DeepEqual(v, sslConfigProp)) {
...
func resourceAlloydbClusterRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("create_time", flattenAlloydbClusterCreateTime(res["createTime"], d, config)); err != nil {
		return fmt.Errorf("Error reading Cluster: %s", err)
	}
	if err := d.Set("update_time", flattenAlloydbClusterUpdateTime(res["updateTime"], d, config)); err != nil {
		return fmt.Errorf("Error reading Cluster: %s", err)
	}
	...
	if err := d.Set("self_link", flattenAlloydbClusterSelfLink(res["selfLink"], d, config)); err != nil {
		return fmt.Errorf("Error reading Cluster: %s", err)
	}
	...
	if err := d.Set("ssl_config", flattenAlloydbClusterSslConfig(res["sslConfig"], d, config)); err != nil {
		return fmt.Errorf("Error reading Cluster: %s", err)
	}
...
func resourceAlloydbClusterUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("ssl_config"); !isEmptyValue(reflect.ValueOf(v)) && (ok || !reflect.DeepEqual(v, sslConfigProp)) {
		obj["sslConfig"] = sslConfigProp
	}
	automatedBackupPolicyProp, err := expandAlloydbClusterAutomatedBackupPolicy(d.Get("automated_backup_policy"), d, config)
	if err != nil {
...
func flattenAlloydbClusterCreateTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenAlloydbClusterUpdateTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}
...
func flattenAlloydbClusterAnnotations(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}
...
func flattenAlloydbClusterState(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenAlloydbClusterSelfLink(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}
...
func flattenAlloydbClusterReconciling(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenAlloydbClusterSslConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	...
	transformed["ssl_mode"] =
		flattenAlloydbClusterSslConfigSslMode(original["sslMode"], d, config)
	transformed["ca_source"] =
		flattenAlloydbClusterSslConfigCaSource(original["caSource"], d, config)
	return []interface{}{transformed}
}
func flattenAlloydbClusterSslConfigSslMode(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenAlloydbClusterSslConfigCaSource(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}
...
func expandAlloydbClusterAnnotations(v interface{}, d TerraformResourceData, config *Config) (map[string]string, error) {
	if v == nil {
		return map[string]string{}, nil
	}
	m := make(map[string]string)
...
func expandAlloydbClusterSslConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedSslMode, err := expandAlloydbClusterSslConfigSslMode(original["ssl_mode"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedSslMode); val.IsValid() && !isEmptyValue(val) {
		transformed["sslMode"] = transformedSslMode
	}

	transformedCaSource, err := expandAlloydbClusterSslConfigCaSource(original["ca_source"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedCaSource); val.IsValid() && !isEmptyValue(val) {
		transformed["caSource"] = transformedCaSource
	}

	return transformed, nil
}

func expandAlloydbClusterSslConfigSslMode(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandAlloydbClusterSslConfigCaSource(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}
