...
resource "google_ml_engine_job" "default" { {
  ...
  training_input {
    job_dir         = "gs://test-project-ml-engine-job/scikit_learn_job_dir%{random_suffix}"
    package_uris    = ["gs://test-project-ml-engine-job/scikit_learn_job_dir/packages/fd65c711be463b2d1e841325d389b6c557db097c2281d40423c8451579238523/census_training-0.0.0.tar.gz%{random_suffix}"]
...
resource "google_ml_engine_job" "default" {
  ...
  training_input {
    job_dir         = "gs://workingnow/tensorflow_census_training%{random_suffix}"
    package_uris    = [""gs://test-project-ml-engine-job/tensorflow_census_training/packages/aa1821b516689e2b95d2a0dec00302e50314e20e8ee303721ca3f31fd46091e3/preprocessing-1.0.tar.gz%{random_suffix}""]
