...
func TestAccCloudFunctionsFunction_vpcConnector(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccCloudFunctionsFunction_vpcConnector(functionName, bucketName, zipFilePath, vpcConnectorName),
			},
		},
	})
}
...
func testAccCloudFunctionsFunction_vpcConnector(functionName, bucketName, zipFilePath, vpcConnectorName string) string {
	return fmt.Sprintf(`
...
}`, vpcConnectorName, bucketName, zipFilePath, functionName)
}
