	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"service_id": {
				...
				Description:  `An service ID to use.`,
			},
			"telemetry": {
...
func resourceMonitoringServiceRead(d *schema.ResourceData, meta interface{}) error {
	...
	if res == nil {
		...
		log.Printf("[DEBUG] Removing MonitoringService because it no longer exists.")
		d.SetId("")
		return nil
	}
...
func resourceMonitoringServiceDecoder(d *schema.ResourceData, meta interface{}, res map[string]interface{}) (map[string]interface{}, error) {
	if v, ok := res["name"]; ok {
		res["serviceId"] = GetResourceNameFromSelfLink(v.(string))
	}
