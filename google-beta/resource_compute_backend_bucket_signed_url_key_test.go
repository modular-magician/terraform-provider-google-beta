...
func TestAccComputeBackendBucketSignedUrlKey_backendBucketSignedUrlKeyExample(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeBackendBucketSignedUrlKey_backendBucketSignedUrlKeyExample(context),
...
func testAccComputeBackendBucketSignedUrlKey_backendBucketSignedUrlKeyExample(context map[string]interface{}) string {
	return Nprintf(`
