...
Projects can be upgraded using the Cloud Billing API https://cloud.google.com/billing/reference/rest/v1/projects/updateBillingInfo. Default value: "USER_DATABASE" Possible values: ["DEFAULT_DATABASE", "USER_DATABASE"]`,
			...
			"database_url": {
				Type:     schema.TypeString,
				Computed: true,
				Description: `The database URL in the form of https://{instance-id}.firebasio.com for us-central1 instances
...
PROJECT_NUMBER: The Firebase project's ['ProjectNumber'](https://firebase.google.com/docs/projects/api/reference/rest/v1beta1/projects#FirebaseProject.FIELDS.project_number)
...
func resourceFirebaseDatabaseInstanceDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if d.Get("type").(string) == "DEFAULT_DATABASE" {
		log.Printf("[DEBUG] Default Firebase Database Instance %q cannot be deleted, left disabled", d.Id())
		return nil
	}
	// end of customized code
