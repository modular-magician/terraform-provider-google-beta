...
func resourceDnsManagedZoneCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("visibility"); !isEmptyValue(reflect.ValueOf(visibilityProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("private_visibility_config"); !isEmptyValue(reflect.ValueOf(privateVisibilityConfigProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("forwarding_config"); !isEmptyValue(reflect.ValueOf(forwardingConfigProp)) {
