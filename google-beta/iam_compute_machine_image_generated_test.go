	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/global/machineImages/%s roles/compute.admin", getTestProjectFromEnv(), fmt.Sprintf("tf-test-image-%s", context["random_suffix"])),
				ImportState:       true,
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/global/machineImages/%s roles/compute.admin user:admin@hashicorptest.com", getTestProjectFromEnv(), fmt.Sprintf("tf-test-image-%s", context["random_suffix"])),
				ImportState:       true,
				ImportStateVerify: true,
			},
		},
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/global/machineImages/%s", getTestProjectFromEnv(), fmt.Sprintf("tf-test-image-%s", context["random_suffix"])),
				ImportState:       true,
				ImportStateVerify: true,
			},
			{
...
func TestAccComputeMachineImageIamBindingGenerated_withCondition(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "google_compute_machine_image_iam_binding.foo",
				ImportStateId:     fmt.Sprintf("projects/%s/global/machineImages/%s roles/compute.admin %s", getTestProjectFromEnv(), fmt.Sprintf("tf-test-image-%s", context["random_suffix"]), context["condition_title"]),
				ImportState:       true,
				ImportStateVerify: true,
			},
		},
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/global/machineImages/%s roles/compute.admin %s", getTestProjectFromEnv(), fmt.Sprintf("tf-test-image-%s", context["random_suffix"]), context["condition_title_no_desc"]),
				ImportState:       true,
				ImportStateVerify: true,
			},
		},
...
func TestAccComputeMachineImageIamMemberGenerated_withCondition(t *testing.T) {
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				ResourceName:      "google_compute_machine_image_iam_member.foo",
				ImportStateId:     fmt.Sprintf("projects/%s/global/machineImages/%s roles/compute.admin user:admin@hashicorptest.com %s", getTestProjectFromEnv(), fmt.Sprintf("tf-test-image-%s", context["random_suffix"]), context["condition_title"]),
				ImportState:       true,
				ImportStateVerify: true,
			},
		},
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/global/machineImages/%s roles/compute.admin user:admin@hashicorptest.com %s", getTestProjectFromEnv(), fmt.Sprintf("tf-test-image-%s", context["random_suffix"]), context["condition_title_no_desc"]),
				ImportState:       true,
				ImportStateVerify: true,
			},
		},
