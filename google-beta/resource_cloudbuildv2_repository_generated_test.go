...
resource "google_cloudbuildv2_repository" "primary" {
  ...
  parent_connection = "projects/%{project_name}/locations/%{region}/connections/${google_cloudbuildv2_connection.ghe_complete.name}"
...
resource "google_cloudbuildv2_connection" "ghe_complete" {
  ...
  github_enterprise_config {
    ...
    app_slug                      = "myapp"
    private_key_secret_version    = "projects/1033762898806/secrets/gcbrepos-dcltest-private-key/versions/1"
    webhook_secret_secret_version = "projects/1033762898806/secrets/gcbrepos-dcltest-webhook-secret/versions/1"
  }
...
resource "google_cloudbuildv2_repository" "primary" {
  name              = "tf-test-repository%{random_suffix}"
  parent_connection = "projects/%{project_name}/locations/%{region}/connections/${google_cloudbuildv2_connection.github_update.name}"
  remote_uri        = "https://github.com/proctor-eng/test2.git"
  annotations       = {}
  provider          = google-beta
}
resource "google_cloudbuildv2_connection" "github_update" {
  ...
  github_config {
    app_installation_id = 236578

    authorizer_credential {
      oauth_token_secret_version = "projects/1033762898806/secrets/gcbrepos-dcltest-github-token/versions/2"
    }
  }
