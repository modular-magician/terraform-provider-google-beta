...
func flattenCertificateManagerCertificateSelfManagedPemCertificate(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenCertificateManagerCertificateSelfManagedPemPrivateKey(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}
