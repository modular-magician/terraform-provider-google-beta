...
func resourceAppEngineDomainMappingUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("ssl_settings") {
		updateMask = append(updateMask, "sslSettings.certificateId")
	}

	if d.HasChange("ssl_settings.0.ssl_management_type") {
		updateMask = append(updateMask, "sslSettings.sslManagementType")
	}
