...
func testSweepBigqueryDataTransferConfig(region string) error {
	...
	listTemplate := strings.Split("https://bigquerydatatransfer.googleapis.com/v1/projects/{{project}}/locations/{{location}}/transferConfigs?serviceAccountName={{serviceAccountName}}", "?")[0]
	...
	for _, ri := range rl {
		...
		deleteTemplate := "https://bigquerydatatransfer.googleapis.com/v1/{{name}}?serviceAccountName={{serviceAccountName}}"
