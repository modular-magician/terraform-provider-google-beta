...
func flattenCloudBuildTriggerGithub(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed := make(map[string]interface{})
	transformed["installation_id"] =
		flattenCloudBuildTriggerGithubInstallationId(original["installationId"], d)
	transformed["owner"] =
...
func flattenCloudBuildTriggerGithubInstallationId(v interface{}, d *schema.ResourceData) interface{} {
	return v
}
