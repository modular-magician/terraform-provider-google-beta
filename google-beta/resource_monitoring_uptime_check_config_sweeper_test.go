...
func testSweepMonitoringUptimeCheckConfig(region string) error {
	resource_name := "MonitoringUptimeCheckConfig"
	...
	list_template := strings.Split("https://monitoring.googleapis.com/v3/projects/{{project}}/uptimeCheckConfigs", "?")[0]
	...
	resource_list, ok := res["uptimeCheckConfigs"]
	if !ok {
