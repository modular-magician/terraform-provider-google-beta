	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			...
			"ancestor": {
				...
				Description: `Policy for including ancestors in the index.  Either all ancestors or none will
be included, the default is none.`,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"direction": {
							...
							Description:  `Which direction should the index optimize for sorting?`,
						},
						"name": {
							Type:        schema.TypeString,
							Required:    true,
			...
			"index_id": {
				Type:        schema.TypeString,
				Computed:    true,
				Description: `The index id. Output only.`,
			},
			"project": {
				Type:     schema.TypeString,
				Optional: true,
