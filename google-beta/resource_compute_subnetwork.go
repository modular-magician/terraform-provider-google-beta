...
func resourceComputeSubnetworkUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if d.HasChange("enable_flow_logs") || d.HasChange("fingerprint") || d.HasChange("secondary_ip_range") || d.HasChange("log_config") {
		obj := make(map[string]interface{})
		enableFlowLogsProp, err := expandComputeSubnetworkEnableFlowLogs(d.Get("enable_flow_logs"), d, config)
		if err != nil {
			return err
...
func flattenComputeSubnetworkLogConfig(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed["enable"] =
		flattenComputeSubnetworkLogConfigEnable(original["enable"], d)
...
func flattenComputeSubnetworkLogConfigEnable(v interface{}, d *schema.ResourceData) interface{} {
	return v
}
...
func expandComputeSubnetworkLogConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	...
	transformedEnable, err := expandComputeSubnetworkLogConfigEnable(original["enable"], d, config)
	if err != nil {
		return nil, err
...
func expandComputeSubnetworkLogConfigEnable(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}
