...
func resourceAccessContextManagerServicePerimeterResourceRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("resource", flattenAccessContextManagerServicePerimeterResourceResource(res["resource"], d)); err != nil {
...
func flattenAccessContextManagerServicePerimeterResourceResource(v interface{}, d *schema.ResourceData) interface{} {
	return v
}
...
func resourceAccessContextManagerServicePerimeterResourceFindNestedObjectInList(d *schema.ResourceData, meta interface{}, items []interface{}) (index int, item map[string]interface{}, err error) {
	...
	for idx, itemRaw := range items {
		...
		itemResource := flattenAccessContextManagerServicePerimeterResourceResource(item["resource"], d)
