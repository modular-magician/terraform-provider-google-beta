...
func resourcePubsubSubscriptionCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("topic"); !isEmptyValue(reflect.ValueOf(topicProp)) {
		obj["topic"] = topicProp
	}
	...
	if err != nil {
		return err
	} else if v := d.Get("push_config"); !isEmptyValue(reflect.ValueOf(pushConfigProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("ack_deadline_seconds"); !isEmptyValue(reflect.ValueOf(ackDeadlineSecondsProp)) {
