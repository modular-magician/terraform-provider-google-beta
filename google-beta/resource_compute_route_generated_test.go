...
resource "google_compute_route" "default" {
  name        = "network-route%<random_suffix>s"
...
resource "google_compute_network" "default" {
  name = "compute-network%<random_suffix>s"
}
`, context)
}
...
resource "google_compute_subnetwork" "default" {
  name          = "compute-subnet%<random_suffix>s"
...
resource "google_compute_health_check" "hc" {
  name               = "proxy-health-check%<random_suffix>s"
...
resource "google_compute_region_backend_service" "backend" {
  name          = "compute-backend%<random_suffix>s"
  region        = "us-central1"
  health_checks = [google_compute_health_check.hc.self_link]
}

resource "google_compute_forwarding_rule" "default" {
  name     = "compute-forwarding-rule%<random_suffix>s"
  region   = "us-central1"
...
resource "google_compute_route" "route-ilb" {
  name         = "route-ilb%<random_suffix>s"
