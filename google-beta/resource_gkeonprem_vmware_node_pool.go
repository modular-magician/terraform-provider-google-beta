...
func ResourceGkeonpremVmwareNodePool() *schema.Resource {
	return &schema.Resource{
		...
		Timeouts: &schema.ResourceTimeout{
			Create: schema.DefaultTimeout(55 * time.Minute),
							...
							Elem: &schema.Resource{
								Schema: map[string]*schema.Schema{
									"effect": {
										...
										Description:  `Specifies the nodes operating system (default: LINUX). Possible values: ["EFFECT_UNSPECIFIED", "NO_SCHEDULE", "PREFER_NO_SCHEDULE", "NO_EXECUTE"]`,
									},
									"key": {
										Type:        schema.TypeString,
										Optional:    true,
...
func resourceGkeonpremVmwareNodePoolRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return handleNotFoundError(err, d, fmt.Sprintf("GkeonpremVmwareNodePool %q", d.Id()))
	}
...
func resourceGkeonpremVmwareNodePoolDelete(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return handleNotFoundError(err, d, "VmwareNodePool")
	}
...
func flattenGkeonpremVmwareNodePoolDisplayName(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolUid(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolState(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolReconciling(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolCreateTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolUpdateTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolDeleteTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolEtag(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolAnnotations(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolNodePoolAutoscaling(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
...
func flattenGkeonpremVmwareNodePoolNodePoolAutoscalingMinReplicas(v interface{}, d *schema.ResourceData, config *Config) interface{} {
...
func flattenGkeonpremVmwareNodePoolNodePoolAutoscalingMaxReplicas(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareNodePoolConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareNodePoolConfigCpus(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareNodePoolConfigMemoryMb(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareNodePoolConfigReplicas(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareNodePoolConfigImageType(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigImage(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigBootDiskSizeGb(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareNodePoolConfigTaints(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareNodePoolConfigTaintsKey(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigTaintsValue(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigTaintsEffect(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigLabels(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigVsphereConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareNodePoolConfigVsphereConfigDatastore(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigVsphereConfigTags(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareNodePoolConfigVsphereConfigTagsCategory(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigVsphereConfigTagsTag(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolConfigEnableLoadBalancer(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolStatus(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareNodePoolStatusErrorMessage(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolStatusConditions(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareNodePoolStatusConditionsType(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolStatusConditionsReason(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolStatusConditionsMessage(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolStatusConditionsLastTransitionTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolStatusConditionsState(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareNodePoolOnPremVersion(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func expandGkeonpremVmwareNodePoolDisplayName(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolAnnotations(v interface{}, d TerraformResourceData, config *Config) (map[string]string, error) {
	if v == nil {
...
func expandGkeonpremVmwareNodePoolNodePoolAutoscaling(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareNodePoolNodePoolAutoscalingMinReplicas(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolNodePoolAutoscalingMaxReplicas(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareNodePoolConfigCpus(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigMemoryMb(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigReplicas(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigImageType(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigImage(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigBootDiskSizeGb(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigTaints(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
...
func expandGkeonpremVmwareNodePoolConfigTaintsKey(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigTaintsValue(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigTaintsEffect(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigLabels(v interface{}, d TerraformResourceData, config *Config) (map[string]string, error) {
	if v == nil {
		return map[string]string{}, nil
	}
	m := make(map[string]string)
...
func expandGkeonpremVmwareNodePoolConfigVsphereConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareNodePoolConfigVsphereConfigDatastore(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigVsphereConfigTags(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	req := make([]interface{}, 0, len(l))
	for _, raw := range l {
		if raw == nil {
...
func expandGkeonpremVmwareNodePoolConfigVsphereConfigTagsCategory(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigVsphereConfigTagsTag(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolConfigEnableLoadBalancer(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareNodePoolOnPremVersion(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}
