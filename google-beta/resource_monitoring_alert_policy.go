...
func resourceMonitoringAlertPolicyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("combiner"); !isEmptyValue(reflect.ValueOf(combinerProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("conditions"); !isEmptyValue(reflect.ValueOf(conditionsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("notification_channels"); !isEmptyValue(reflect.ValueOf(notificationChannelsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("documentation"); !isEmptyValue(reflect.ValueOf(documentationProp)) {
