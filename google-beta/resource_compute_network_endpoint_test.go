...
func TestAccComputeNetworkEndpoint_networkEndpointsBasic(t *testing.T) {
	...
	secondEndpt := &networkEndptTestId{}
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testAccCheckComputeNetworkEndpointExists("google_compute_network_endpoint.second-endpoint", secondEndpt),
				),
			},
			{
...
resource "google_compute_network_endpoint" "second-endpoint" {
 provider               = "google-beta"
