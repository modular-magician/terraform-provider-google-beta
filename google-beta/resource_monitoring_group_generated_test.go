...
resource "google_monitoring_group" "basic" {
  display_name = "tf-test MonitoringGroup%<random_suffix>s"
...
resource "google_monitoring_group" "parent" {
  display_name = "tf-test MonitoringParentGroup%<random_suffix>s"
  filter       = "resource.metadata.region=\"europe-west2\""
}

resource "google_monitoring_group" "subgroup" {
  display_name = "tf-test MonitoringSubGroup%<random_suffix>s"
  filter       = "resource.metadata.region=\"europe-west2\""
