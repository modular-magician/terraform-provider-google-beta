...
resource "google_monitoring_group" "basic" {
  display_name = "tf-test tf-test-MonitoringGroup%{random_suffix}"
...
resource "google_monitoring_group" "parent" {
  display_name = "tf-test tf-test-MonitoringParentGroup%{random_suffix}"
  filter       = "resource.metadata.region=\"europe-west2\""
}

resource "google_monitoring_group" "subgroup" {
  display_name = "tf-test tf-test-MonitoringSubGroup%{random_suffix}"
  filter       = "resource.metadata.region=\"europe-west2\""
