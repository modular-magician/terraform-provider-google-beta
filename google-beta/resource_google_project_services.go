...
func resourceGoogleProjectServices() *schema.Resource {
	return &schema.Resource{
        ...
        "issues with dependent services that were not resolvable.  Please use google_project_service " +
        "or the terraform-google-modules/terraform-google-project-factory project_services module.  " +
