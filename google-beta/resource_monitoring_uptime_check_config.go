...
func resourceMonitoringUptimeCheckConfigRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("name", flattenMonitoringUptimeCheckConfigName(res["name"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("display_name", flattenMonitoringUptimeCheckConfigDisplayName(res["displayName"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("period", flattenMonitoringUptimeCheckConfigPeriod(res["period"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("timeout", flattenMonitoringUptimeCheckConfigTimeout(res["timeout"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("content_matchers", flattenMonitoringUptimeCheckConfigContentMatchers(res["contentMatchers"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("selected_regions", flattenMonitoringUptimeCheckConfigSelectedRegions(res["selectedRegions"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("is_internal", flattenMonitoringUptimeCheckConfigIsInternal(res["isInternal"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("internal_checkers", flattenMonitoringUptimeCheckConfigInternalCheckers(res["internalCheckers"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("http_check", flattenMonitoringUptimeCheckConfigHttpCheck(res["httpCheck"], d)); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("tcp_check", flattenMonitoringUptimeCheckConfigTcpCheck(res["tcpCheck"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("resource_group", flattenMonitoringUptimeCheckConfigResourceGroup(res["resourceGroup"], d)); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
	if err := d.Set("monitored_resource", flattenMonitoringUptimeCheckConfigMonitoredResource(res["monitoredResource"])); err != nil {
		return fmt.Errorf("Error reading UptimeCheckConfig: %s", err)
	}
...
func flattenMonitoringUptimeCheckConfigName(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigDisplayName(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigPeriod(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigTimeout(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigContentMatchers(v interface{}) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
	...
	for _, raw := range l {
		...
		transformed = append(transformed, map[string]interface{}{
			"content": flattenMonitoringUptimeCheckConfigContentMatchersContent(original["content"]),
		})
	}
	return transformed
}
func flattenMonitoringUptimeCheckConfigContentMatchersContent(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigSelectedRegions(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigIsInternal(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigInternalCheckers(v interface{}) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
	...
	for _, raw := range l {
		...
		transformed = append(transformed, map[string]interface{}{
			"gcp_zone":        flattenMonitoringUptimeCheckConfigInternalCheckersGcpZone(original["gcpZone"]),
			"peer_project_id": flattenMonitoringUptimeCheckConfigInternalCheckersPeerProjectId(original["peerProjectId"]),
			"name":            flattenMonitoringUptimeCheckConfigInternalCheckersName(original["name"]),
			"network":         flattenMonitoringUptimeCheckConfigInternalCheckersNetwork(original["network"]),
			"display_name":    flattenMonitoringUptimeCheckConfigInternalCheckersDisplayName(original["displayName"]),
		})
	}
	return transformed
}
func flattenMonitoringUptimeCheckConfigInternalCheckersGcpZone(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigInternalCheckersPeerProjectId(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigInternalCheckersName(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigInternalCheckersNetwork(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigInternalCheckersDisplayName(v interface{}) interface{} {
	return v
}
...
func flattenMonitoringUptimeCheckConfigHttpCheck(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed["port"] =
		flattenMonitoringUptimeCheckConfigHttpCheckPort(original["port"])
	transformed["headers"] =
		flattenMonitoringUptimeCheckConfigHttpCheckHeaders(original["headers"])
	transformed["path"] =
		flattenMonitoringUptimeCheckConfigHttpCheckPath(original["path"])
	transformed["use_ssl"] =
		flattenMonitoringUptimeCheckConfigHttpCheckUseSsl(original["useSsl"])
	transformed["mask_headers"] =
		flattenMonitoringUptimeCheckConfigHttpCheckMaskHeaders(original["maskHeaders"])
...
func flattenMonitoringUptimeCheckConfigHttpCheckAuthInfo(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed["username"] =
		flattenMonitoringUptimeCheckConfigHttpCheckAuthInfoUsername(original["username"])
	return []interface{}{transformed}
}
...
func flattenMonitoringUptimeCheckConfigHttpCheckAuthInfoUsername(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigHttpCheckPort(v interface{}) interface{} {
...
func flattenMonitoringUptimeCheckConfigHttpCheckHeaders(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigHttpCheckPath(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigHttpCheckUseSsl(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigHttpCheckMaskHeaders(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigTcpCheck(v interface{}) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
	...
	transformed := make(map[string]interface{})
	transformed["port"] =
		flattenMonitoringUptimeCheckConfigTcpCheckPort(original["port"])
	return []interface{}{transformed}
}
func flattenMonitoringUptimeCheckConfigTcpCheckPort(v interface{}) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := strconv.ParseInt(strVal, 10, 64); err == nil {
			return intVal
...
func flattenMonitoringUptimeCheckConfigResourceGroup(v interface{}, d *schema.ResourceData) interface{} {
	...
	transformed["resource_type"] =
		flattenMonitoringUptimeCheckConfigResourceGroupResourceType(original["resourceType"])
	transformed["group_id"] =
		flattenMonitoringUptimeCheckConfigResourceGroupGroupId(original["groupId"], d)
	return []interface{}{transformed}
}
func flattenMonitoringUptimeCheckConfigResourceGroupResourceType(v interface{}) interface{} {
	return v
}
...
func flattenMonitoringUptimeCheckConfigMonitoredResource(v interface{}) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
	...
	transformed := make(map[string]interface{})
	transformed["type"] =
		flattenMonitoringUptimeCheckConfigMonitoredResourceType(original["type"])
	transformed["labels"] =
		flattenMonitoringUptimeCheckConfigMonitoredResourceLabels(original["labels"])
	return []interface{}{transformed}
}
func flattenMonitoringUptimeCheckConfigMonitoredResourceType(v interface{}) interface{} {
	return v
}

func flattenMonitoringUptimeCheckConfigMonitoredResourceLabels(v interface{}) interface{} {
	return v
}
