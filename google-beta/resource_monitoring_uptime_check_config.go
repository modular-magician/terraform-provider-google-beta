...
func resourceMonitoringUptimeCheckConfigCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("period"); !isEmptyValue(reflect.ValueOf(periodProp)) {
		obj["period"] = periodProp
	}
	timeoutProp, err := expandMonitoringUptimeCheckConfigTimeout(d.Get("timeout"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("timeout"); !isEmptyValue(reflect.ValueOf(timeoutProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("content_matchers"); !isEmptyValue(reflect.ValueOf(contentMatchersProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("selected_regions"); !isEmptyValue(reflect.ValueOf(selectedRegionsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("is_internal"); !isEmptyValue(reflect.ValueOf(isInternalProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("internal_checkers"); !isEmptyValue(reflect.ValueOf(internalCheckersProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("http_check"); !isEmptyValue(reflect.ValueOf(httpCheckProp)) {
		obj["httpCheck"] = httpCheckProp
	}
	tcpCheckProp, err := expandMonitoringUptimeCheckConfigTcpCheck(d.Get("tcp_check"), d, config)
	if err != nil {
		return err
	} else if v := d.Get("tcp_check"); !isEmptyValue(reflect.ValueOf(tcpCheckProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("resource_group"); !isEmptyValue(reflect.ValueOf(resourceGroupProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("monitored_resource"); !isEmptyValue(reflect.ValueOf(monitoredResourceProp)) {
