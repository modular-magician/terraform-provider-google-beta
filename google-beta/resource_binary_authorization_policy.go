...
func resourceBinaryAuthorizationPolicyCreate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v := d.Get("admission_whitelist_patterns"); !isEmptyValue(reflect.ValueOf(admissionWhitelistPatternsProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("cluster_admission_rules"); !isEmptyValue(reflect.ValueOf(clusterAdmissionRulesProp)) {
	...
	if err != nil {
		return err
	} else if v := d.Get("default_admission_rule"); !isEmptyValue(reflect.ValueOf(defaultAdmissionRuleProp)) {
