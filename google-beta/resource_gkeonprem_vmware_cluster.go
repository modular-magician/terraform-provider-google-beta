...
Enabled by default.`,
			...
			"workflow_identity": {
				Type:     schema.TypeList,
				Optional: true,
				Description: `Authenticate to Google without requiring you to download, manually rotate,
				...
				Elem: &schema.Resource{
					Schema: map[string]*schema.Schema{
						"workflow_identity_disabled": {
							Type:     schema.TypeBool,
							Optional: true,
							Description: `Whether or not workload identity is disabled in the cluster.
...
func resourceGkeonpremVmwareClusterCreate(d *schema.ResourceData, meta interface{}) error {
	...
	workflowIdentityProp, err := expandGkeonpremVmwareClusterWorkflowIdentity(d.Get("workflow_identity"), d, config)
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("workflow_identity"); !isEmptyValue(reflect.ValueOf(workflowIdentityProp)) && (ok || !reflect.DeepEqual(v, workflowIdentityProp)) {
		obj["workflowIdentity"] = workflowIdentityProp
	}
...
func resourceGkeonpremVmwareClusterRead(d *schema.ResourceData, meta interface{}) error {
	...
	if err := d.Set("workflow_identity", flattenGkeonpremVmwareClusterWorkflowIdentity(res["workflowIdentity"], d, config)); err != nil {
		return fmt.Errorf("Error reading VmwareCluster: %s", err)
	}
...
func resourceGkeonpremVmwareClusterUpdate(d *schema.ResourceData, meta interface{}) error {
	...
	if err != nil {
		return err
	} else if v, ok := d.GetOkExists("workflow_identity"); !isEmptyValue(reflect.ValueOf(v)) && (ok || !reflect.DeepEqual(v, workflowIdentityProp)) {
		obj["workflowIdentity"] = workflowIdentityProp
	}
	antiAffinityGroupsProp, err := expandGkeonpremVmwareClusterAntiAffinityGroups(d.Get("anti_affinity_groups"), d, config)
	if err != nil {
	...
	if d.HasChange("workflow_identity") {
		updateMask = append(updateMask, "workflowIdentity")
	}
...
func flattenGkeonpremVmwareClusterAdminClusterMembership(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterDescription(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterOnPremVersion(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterUid(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterState(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterEndpoint(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterReconciling(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterCreateTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterUpdateTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterDeleteTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLocalName(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterEtag(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterAnnotations(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterControlPlaneNode(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
...
func flattenGkeonpremVmwareClusterControlPlaneNodeCpus(v interface{}, d *schema.ResourceData, config *Config) interface{} {
...
func flattenGkeonpremVmwareClusterControlPlaneNodeMemory(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareClusterControlPlaneNodeReplicas(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareClusterControlPlaneNodeAutoResizeConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterControlPlaneNodeAutoResizeConfigEnabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterControlPlaneNodeVsphereConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterControlPlaneNodeVsphereConfigDatastore(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterWorkflowIdentity(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
	...
	transformed := make(map[string]interface{})
	transformed["workflow_identity_disabled"] =
		flattenGkeonpremVmwareClusterWorkflowIdentityWorkflowIdentityDisabled(original["workflowIdentityDisabled"], d, config)
	return []interface{}{transformed}
}
func flattenGkeonpremVmwareClusterWorkflowIdentityWorkflowIdentityDisabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterAntiAffinityGroups(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterAntiAffinityGroupsAagConfigDisabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterStorage(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterStorageVsphereCsiDisabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigServiceAddressCidrBlocks(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigPodAddressCidrBlocks(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigStaticIpConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocks(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksNetmask(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksGateway(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksIps(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksIpsIp(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksIpsHostname(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigDhcpIpConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigDhcpIpConfigEnabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigVcenterNetwork(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigHostConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigHostConfigDnsServers(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigHostConfigNtpServers(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigHostConfigDnsSearchDomains(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigControlPlaneV2Config(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockNetmask(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockGateway(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIps(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpsIp(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpsHostname(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancer(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterLoadBalancerVipConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterLoadBalancerVipConfigControlPlaneVip(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerVipConfigIngressVip(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerF5Config(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterLoadBalancerF5ConfigAddress(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerF5ConfigPartition(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerF5ConfigSnatPool(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerManualLbConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterLoadBalancerManualLbConfigIngressHttpNodePort(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareClusterLoadBalancerManualLbConfigIngressHttpsNodePort(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareClusterLoadBalancerManualLbConfigControlPlaneNodePort(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareClusterLoadBalancerManualLbConfigKonnectivityServerNodePort(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	// Handles the string fixed64 format
	if strVal, ok := v.(string); ok {
		if intVal, err := StringToFixed64(strVal); err == nil {
			return intVal
...
func flattenGkeonpremVmwareClusterLoadBalancerMetalLbConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPools(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsPool(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsAddresses(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsAvoidBuggyIps(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsManualAssign(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVcenter(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterVcenterResourcePool(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVcenterDatastore(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVcenterDatacenter(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVcenterCluster(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVcenterFolder(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVcenterCaCertData(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVcenterAddress(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterStatus(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterStatusErrorMessage(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterStatusConditions(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareClusterStatusConditionsType(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterStatusConditionsReason(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterStatusConditionsMessage(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterStatusConditionsLastTransitionTime(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterStatusConditionsState(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterDataplaneV2(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterDataplaneV2DataplaneV2Enabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterDataplaneV2WindowsDataplaneV2Enabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterDataplaneV2AdvancedNetworking(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterVmTrackingEnabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterAutoRepairConfig(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterAutoRepairConfigEnabled(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterFleet(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterFleetMembership(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterAuthorization(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterAuthorizationAdminUsers(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareClusterAuthorizationAdminUsersUsername(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterValidationCheck(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterValidationCheckOptions(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterValidationCheckStatus(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return nil
	}
	original := v.(map[string]interface{})
...
func flattenGkeonpremVmwareClusterValidationCheckStatusResult(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	if v == nil {
		return v
	}
	l := v.([]interface{})
...
func flattenGkeonpremVmwareClusterValidationCheckStatusResultOptions(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterValidationCheckStatusResultDescription(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterValidationCheckStatusResultCategory(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterValidationCheckStatusResultReason(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterValidationCheckStatusResultDetails(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterValidationCheckScenario(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func flattenGkeonpremVmwareClusterEnableControlPlaneV2(v interface{}, d *schema.ResourceData, config *Config) interface{} {
	return v
}

func expandGkeonpremVmwareClusterAdminClusterMembership(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterDescription(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterOnPremVersion(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterAnnotations(v interface{}, d TerraformResourceData, config *Config) (map[string]string, error) {
	if v == nil {
...
func expandGkeonpremVmwareClusterControlPlaneNode(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterControlPlaneNodeCpus(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterControlPlaneNodeMemory(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterControlPlaneNodeReplicas(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterControlPlaneNodeAutoResizeConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterControlPlaneNodeAutoResizeConfigEnabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterControlPlaneNodeVsphereConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterControlPlaneNodeVsphereConfigDatastore(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterWorkflowIdentity(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
	...
	transformedWorkflowIdentityDisabled, err := expandGkeonpremVmwareClusterWorkflowIdentityWorkflowIdentityDisabled(original["workflow_identity_disabled"], d, config)
	if err != nil {
		return nil, err
	} else if val := reflect.ValueOf(transformedWorkflowIdentityDisabled); val.IsValid() && !isEmptyValue(val) {
		transformed["workflowIdentityDisabled"] = transformedWorkflowIdentityDisabled
	}

	return transformed, nil
}

func expandGkeonpremVmwareClusterWorkflowIdentityWorkflowIdentityDisabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterAntiAffinityGroups(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterAntiAffinityGroupsAagConfigDisabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterStorage(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterStorageVsphereCsiDisabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterNetworkConfigServiceAddressCidrBlocks(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigPodAddressCidrBlocks(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigStaticIpConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocks(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
...
func expandGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksNetmask(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksGateway(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksIps(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	req := make([]interface{}, 0, len(l))
	for _, raw := range l {
		if raw == nil {
...
func expandGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksIpsIp(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigStaticIpConfigIpBlocksIpsHostname(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigDhcpIpConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterNetworkConfigDhcpIpConfigEnabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigVcenterNetwork(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigHostConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterNetworkConfigHostConfigDnsServers(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigHostConfigNtpServers(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigHostConfigDnsSearchDomains(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigControlPlaneV2Config(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlock(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockNetmask(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockGateway(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIps(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	req := make([]interface{}, 0, len(l))
	for _, raw := range l {
		if raw == nil {
...
func expandGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpsIp(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterNetworkConfigControlPlaneV2ConfigControlPlaneIpBlockIpsHostname(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancer(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterLoadBalancerVipConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterLoadBalancerVipConfigControlPlaneVip(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerVipConfigIngressVip(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerF5Config(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterLoadBalancerF5ConfigAddress(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerF5ConfigPartition(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerF5ConfigSnatPool(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerManualLbConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterLoadBalancerManualLbConfigIngressHttpNodePort(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerManualLbConfigIngressHttpsNodePort(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerManualLbConfigControlPlaneNodePort(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerManualLbConfigKonnectivityServerNodePort(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerMetalLbConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPools(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	req := make([]interface{}, 0, len(l))
	for _, raw := range l {
		if raw == nil {
...
func expandGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsPool(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsAddresses(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsAvoidBuggyIps(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterLoadBalancerMetalLbConfigAddressPoolsManualAssign(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterDataplaneV2(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterDataplaneV2DataplaneV2Enabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterDataplaneV2WindowsDataplaneV2Enabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterDataplaneV2AdvancedNetworking(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterVmTrackingEnabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterAutoRepairConfig(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterAutoRepairConfigEnabled(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterAuthorization(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandGkeonpremVmwareClusterAuthorizationAdminUsers(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	l := v.([]interface{})
	req := make([]interface{}, 0, len(l))
	for _, raw := range l {
		if raw == nil {
...
func expandGkeonpremVmwareClusterAuthorizationAdminUsersUsername(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}

func expandGkeonpremVmwareClusterEnableControlPlaneV2(v interface{}, d TerraformResourceData, config *Config) (interface{}, error) {
	return v, nil
}
