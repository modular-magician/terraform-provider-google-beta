...
func expandCloudRunV2JobTemplateTemplateVolumesEmptyDir(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	l := v.([]interface{})
	if len(l) == 0 || l[0] == nil {
		return nil, nil
	}
...
func expandCloudRunV2JobTemplateTemplateVolumesEmptyDirMedium(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}

func expandCloudRunV2JobTemplateTemplateVolumesEmptyDirSizeLimit(v interface{}, d TerraformResourceData, config *transport_tpg.Config) (interface{}, error) {
	return v, nil
}
