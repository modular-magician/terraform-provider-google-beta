...
func TestAccComputeBackendService_backendServiceGlobalInternalExample(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccComputeBackendService_backendServiceGlobalInternalExample(context),
			},
		},
	})
}

func testAccComputeBackendService_backendServiceGlobalInternalExample(context map[string]interface{}) string {
	return Nprintf(`
