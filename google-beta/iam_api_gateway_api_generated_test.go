	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/locations/global/apis/%s roles/apigateway.viewer", getTestProjectFromEnv(), fmt.Sprintf("tf-test-api-%s", context["random_suffix"])),
				ImportState:       true,
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/locations/global/apis/%s roles/apigateway.viewer user:admin@hashicorptest.com", getTestProjectFromEnv(), fmt.Sprintf("tf-test-api-%s", context["random_suffix"])),
				ImportState:       true,
				ImportStateVerify: true,
			},
		},
	...
	vcrTest(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			},
			{
				...
				ImportStateId:     fmt.Sprintf("projects/%s/locations/global/apis/%s", getTestProjectFromEnv(), fmt.Sprintf("tf-test-api-%s", context["random_suffix"])),
				ImportState:       true,
				ImportStateVerify: true,
			},
			{
