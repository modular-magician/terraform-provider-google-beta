...
func testSweepMonitoringAlertPolicy(region string) error {
	resource_name := "MonitoringAlertPolicy"
	...
	list_template := strings.Split("https://monitoring.googleapis.com/v3/projects/{{project}}/alertPolicies", "?")[0]
	...
	resource_list, ok := res["alertPolicies"]
	if !ok {
