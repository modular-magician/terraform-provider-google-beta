...
func TestAccAppEngineApplicationUrlDispatchRules_appEngineApplicationUrlDispatchRuleExample(t *testing.T) {
	t.Parallel()
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			{
				Config: testAccAppEngineApplicationUrlDispatchRules_appEngineApplicationUrlDispatchRuleExample(context),
			},
			{
...
func testAccAppEngineApplicationUrlDispatchRules_appEngineApplicationUrlDispatchRuleExample(context map[string]interface{}) string {
	return Nprintf(`
